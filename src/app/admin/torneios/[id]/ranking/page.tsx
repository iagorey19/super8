...
const positionStyle = (pos: number) => {
  ...
  if (pos === 2) return "bg-gray-200 text-gray-700 border-gray-300 font-semibold"
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-3 flex-wrap">
        ...
        {tournament && (
          <Badge className={tournament.status === "ongoing" ? "bg-green-100 text-green-800 animate-pulse" : ""}>
