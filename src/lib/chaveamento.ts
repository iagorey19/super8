...
export const WHIST_SCHEDULE = [
  { round: 1, courtA: { t1: [1, 2], t2: [3, 4] }, courtB: { t1: [5, 6], t2: [7, 8] } },
  { round: 2, courtA: { t1: [1, 3], t2: [6, 8] }, courtB: { t1: [2, 4], t2: [5, 7] } },
  { round: 3, courtA: { t1: [1, 4], t2: [6, 7] }, courtB: { t1: [2, 3], t2: [5, 8] } },
  { round: 4, courtA: { t1: [1, 5], t2: [4, 8] }, courtB: { t1: [2, 6], t2: [3, 7] } },
  { round: 5, courtA: { t1: [1, 6], t2: [2, 5] }, courtB: { t1: [3, 8], t2: [4, 7] } },
  { round: 6, courtA: { t1: [1, 7], t2: [3, 5] }, courtB: { t1: [2, 8], t2: [4, 6] } },
  { round: 7, courtA: { t1: [1, 8], t2: [2, 7] }, courtB: { t1: [3, 6], t2: [4, 5] } },
]
