...
export function Navbar({ variant = "authenticated" }: { variant?: "authenticated" | "public" }) {
  ...
  const logoLink = user ? `/${rolePrefix[user.role] || user.role}` : "/eventos"
