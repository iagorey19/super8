      ...
      {open && (
        <div className="px-4 pb-4 space-y-4 text-sm text-gray-600 dark:text-gray-400">
          ...
          <div>
            ...
            <p>A classificação final considera a <strong>soma de pontos de todas as rodadas</strong>.</p>
          </div>
          ...
          <div>
            ...
            <p>
              O ranking anual acumula os pontos de <strong>todos os torneios do ano</strong>.
